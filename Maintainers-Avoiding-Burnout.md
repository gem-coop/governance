...
access** to Gem.coop's repository and help merge the contributions of
others. You may find what is written here interesting, but it’s
definitely not for everyone.

## 1. Use Gem.coop

Maintainers of Gem.coop should be using it regularly. This is partly because
you won't be a good maintainer unless you can put yourself in the shoes of our
users, but also because you may decide to stop using Gem.coop and at that point
you should also decide not to be a maintainer and find other things to work on.

## 2. No Guilt About Leaving

All maintainers can stop working on Gem.coop at any time without any guilt or
...
work). Like a job, you should probably take a break from Gem.coop at least a few
times a year.
...
above, Gem.coop's minimum number of users will be the number of maintainers.
However, if Gem.coop has no maintainers it will quickly become useless to all
...
Gem.coop gets a lot of feature requests, non-reproducible bug reports, usage
...
completed ASAP. Try to not feel this pressure; slow down, focus on Gem.coop
