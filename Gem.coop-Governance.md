...
1. Any member may refer any financial questions, AGM questions or code of conduct violations to the PLC. Members will make a good faith effort to resolve any disputes with compromise prior to referral to the PLC.

1. The PLC will represent Gem Cooperative publicly, and resolve disputes related to the operation of Gem Cooperative between maintainers, members, other contributors, and users.

1. In case of a casual vacancy in the PLC, the usual membership voting and selection process will start inmediately to fill in the vacancy.

1. All PLC members, and only them, will be owners of the gem-coop GitHub Organization, Bundler Slack and any related resources.
...
1. The TSC consists of three members. All of them must be maintainers.

1. TSC members are appointed by a majority vote of the PLC. It is recommended that PLC members are not any of these appointees but this may not be possible in the short-term. Appointed TSC members will serve a term of one year or until the member's successor is appointed.
...
1. New maintainers can be nominated by any existing maintainer. To become a maintainer, a nomination requires approval from any member of the TSC with no opposition from any other TSC member within a 1 week period. If there is opposition, the TSC must vote on the nomination in the #gem-coop-tsc private Bundler Slack channel, with the vote closing after one week or after the outcome of the vote would not be changed by any subsequent votes (such as when a majority of the TSC has voted in favour or against). The nomination will succeed by a majority vote of the votes cast.

1. In accordance with Gem Cooperative's organisational security posture, which requires operating under the principle of least privilege, the TSC will review maintainers' write/commit access no later than six weeks before the AGM. The TSC will remove maintainer privileges from those who have not consistently met these criteria:
...
- reviewing and merging of PRs of other maintainers and contributors in primary repositories
  - Non-essential pull requests submitted and merged by the same person will be excluded from consideration
- reviewing any direct GitHub review requests in any repository in the gem-coop organisation
- responding to direct mentions on GitHub and direct mentions in Bundler Slack from other maintainers
- maintaining a positive working relationship with other maintainers
- engaging actively to resolve conflict with other maintainers, with a neutral intermediary upon request

1. Maintainers who do not fulfil these requirements will be removed as a maintainer but may remain a member if they wish.

1. The following activities will not be considered because they do not require commit or write access on security-critical repositories:
...
1. The PLC will review the decision within one week.

1. A member of the PLC will respond immediately upon upholding or reversing the decision. The TSC will restore access as soon as is feasible if the PLC votes to reverse the removal.

1. If the PLC feels that the maintainer has not made sufficient progress on the criteria for any reversed removal, they may request a second TSC review no sooner than 30 days after the initial removal.
...
1. An automatic appeal process is started for any maintainer removed under this provision. The PLC and TSC must review the emergency removal of any maintainer within two weeks and may restore the maintainer's privileges if the situation is resolved.
